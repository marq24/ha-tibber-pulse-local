...
SENSOR_TYPES = [
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010800ff", section=OBIS_DATA_KEY),
        name="Import total",
    ...
    # Zählerstand Tarif 1
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010801ff", section=OBIS_DATA_KEY),
    ...
    # Zählerstand Tarif 2
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010802ff", section=OBIS_DATA_KEY),
    ...
    # Zählerstand Tarif 3
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010803ff", section=OBIS_DATA_KEY),
    ...
    # Zählerstand Tarif 4
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010804ff", section=OBIS_DATA_KEY),
    ...
    # Wirkenergie Total
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020800ff", section=OBIS_DATA_KEY),
        name="Export total",
        entity_registry_enabled_default=False,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020801ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020802ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020803ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020804ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010800ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010801ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010802ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010803ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100010804ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020800ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020801ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020802ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020803ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100020804ff", section=OBIS_DATA_KEY, divide_by_1000=True),
    ...
    # Spannung L1
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100200700ff", section=OBIS_DATA_KEY),
        name="Potential L1",
    ...
    # Spannung L2
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100340700ff", section=OBIS_DATA_KEY),
        name="Potential L2",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        icon="mdi:lightning-bolt",
        device_class=SensorDeviceClass.VOLTAGE,
    ...
    # Spannung L3
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100480700ff", section=OBIS_DATA_KEY),
        name="Potential L3",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        icon="mdi:lightning-bolt",
        device_class=SensorDeviceClass.VOLTAGE,
    ...
    # Strom L1
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="01001f0700ff", section=OBIS_DATA_KEY),
        name="Current L1",
    ...
    # Strom L2
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100330700ff", section=OBIS_DATA_KEY),
        name="Current L2",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        icon="mdi:current-ac",
        device_class=SensorDeviceClass.CURRENT,
    ...
    # Strom L3
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100470700ff", section=OBIS_DATA_KEY),
        name="Current L3",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        icon="mdi:current-ac",
        device_class=SensorDeviceClass.CURRENT,
    ...
    # Netz Frequenz
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="01000e0700ff", section=OBIS_DATA_KEY),
        name="Net frequency",
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100510701ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100510702ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="0100510704ff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="010051070fff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="010051071aff", section=OBIS_DATA_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_battery_voltage", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_temperature", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_avg_rssi", section=METRICS_KEY),
        name="node_avg_rssi",
        suggested_display_precision=3,
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_avg_lqi", section=METRICS_KEY),
        name="node_avg_lqi",
        suggested_display_precision=3,
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_radio_tx_power", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_uptime_ms", section=METRICS_KEY),
        name="node_uptime_ms",
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_meter_msg_count_sent", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_meter_pkg_count_sent", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_time_in_em0_ms", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_time_in_em1_ms", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_time_in_em2_ms", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_acmp_rx_autolevel_9600", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="node_invalid_meter_readings_count", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="hub_meter_pkg_count_recv", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="hub_meter_reading_count_recv", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="hub_meter_corrupt_reading_count_recv", section=METRICS_KEY),
    ...
    ExtSensorEntityDescription.from_tag(
        tag=SensorTag(key="hub_compression_error_readings_count", section=METRICS_KEY),
